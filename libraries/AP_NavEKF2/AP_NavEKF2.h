...
private:
    ...
    AP_Float _visPosNoise;          // visual pos measurement noise
    AP_Int16 _visPosInnovGate;      // Percentage number of standard deviations applied to vis pos innovation consistency check
    AP_Int8  _visPosDelay_ms;       // effective average delay of vis pos measurements rel to IMU (msec)
